...
<html>
    <head>
        <title>Stamps | Israel Stamps</title>
		
	<meta name="keywords" content="Israel, stamps, philately" />
	<meta name="description" content="Israel Stamps best stamps list" />
		<meta charset="utf-8" />
    ...
    <body>
		...
		<div id="bread-crumbs" class="box">
			<div class="center">
                <div class="box"><p>
	<a href="/" title="">Home</a> &gt; Stamps</p></div>
            </div>
		</div>
	...
	<div class="stamps-list box jplist" id="stamps-list">
		...
		<div class="panel box panel-top">
			...
			<div class="drop-down" data-control-type="drop-down" data-control-name="year-filter" data-control-action="filter">
				<ul>
					<li><span data-path="default">Filter by year</span></li>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$7.2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S16</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="'Bezalel' Ceramics Hebron, Jaffa, Haifa, Tiberias" href="/stamp/bezalel-ceramics-hebron-jaffa-haifa-tiberias">Read More</a>
						</div>

						<div class="add-to-cart">
							<span class="item_add popup-lighbox">Add to cart</span>
						</div>
						
						<div class="order-now-btn">
							<a href="/cart" title="" class="item_add">Order now</a>
						</div>
					</div>
				</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S15</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="'Philanippon 2001' World Stamp Exhibition Children Paint Dreams" href="/stamp/world-stamp-exhibition-children-paint-dreams">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S55</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="100 years of FIFA" href="/stamp/100-years-of-fifa">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The stamp shows a photo from the first international game of the Israel National Team, where they played against the U.S.A. National Team in New York and lost 1:3.<br/> Shmuel Ben-Dror, is pictured in the photo, scoring the only goal for the Israeli team.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S57</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="100 years of FIFA - First Day Cover" href="/stamp/100-years-of-fifa-first-day-cover">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$3.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S40</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="50 Years Israel Aircraft Industry" href="/stamp/50-years-israel-aircraft-industry">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$6.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S53</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="50 years of the union of European Football Associations UEFA" href="/stamp/50-years-of-the-union-of-european-football-associations-uefa">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>UEFA – The Union of European Football Associations, is the European Football Confederation.<br/> UEFA was founded on June 15, 1954, during the World Cup games in Switzerland.<br/> Representatives of 30 National Associations, which sought to strengthen the European position in football around the world, were involved in the foundation of UEFA.<br/> The first competition established by UEFA was the European Champion Clubs Cup, later to be re-named the UEFA Champions league. In 1960, UEFA decided to run competitions for national teams as well, with the introduction of the Nations’ Cup (now the European Football Championship). Among the other club competitions are the UEFA Cup and the Intertoto Cup.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S58</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="50 years of the union of European Football Associations UEFA - First Day Cover" href="/stamp/50-years-of-the-union-of-european-football-associations-uefa-first-day-cover">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S46</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Armenian Ceramics in Jerusalem" href="/stamp/armenian-ceramics-in-jerusalem">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S34</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Art Michael Gross 'September 11'" href="/stamp/art-michael-gross-september-11">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S14</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Belgica 2001, World Stamp Exhibition The Diamond Industry in Israel" href="/stamp/world-stamp-exhibition-the-diamond-industry-in-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$6.9</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S24</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Birds of the Jordan Valley" href="/stamp/birds-of-the-jordan-valley">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$9.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S23</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Cable Cars" href="/stamp/cable-cars">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S44</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Centenary of Villages" href="/stamp/centenary-of-villages">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$9.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S26</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Children's Games - Philately Day" href="/stamp/childrens-games-philately-day">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.7</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S1</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Festival Stamps (5761) - 2000 Jewish New Year Cards" href="/stamp/festival-stamps">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.7</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S25</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Festivals - Wine in Israel" href="/stamp/festivals-wine-in-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S47</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Festivals 2003 Olives in Israel" href="/stamp/festivals-2003-olives-in-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.7</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S18</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Festivals 5762 {2001)" href="/stamp/festivals-5762-2001">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$7</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S12</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Flowers - 'My Own Stamp' Gerbera, Calla, Orinithogalum, Lisianthus" href="/stamp/flowers-my-own-stamp">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$12.6</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S22</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Geology of the Land of Israel Souvenir Sheet" href="/stamp/geology-of-the-land-of-israel-souvenir-sheet">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$3.6</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S17</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Georgia - Israel" href="/stamp/georgia-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$11</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S37</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Good Wishes" href="/stamp/good-wishes">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Greetings are part of our way of life. Phrases like Thank You, Good Luck, Congratulations (Mazal Tov) and With Love create pleasant and positive communication between people. Our capability to express how we feel with a short phrase or word that 'says it all' is a wonderful way to make our world a better place. By representing the most used and popular greetings on stamps, the greetings come to life in a colorful, graphic and sometimes humorous ways. The Israel Philatelic Service has issued a set of greetings stamps so that they are suitable for almost any occasion.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$11</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S43</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Greetings Part II" href="/stamp/greetings-part">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S41</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Holocaust and Revival" href="/stamp/holocaust-and-revival">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S51</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ilan Ramon" href="/stamp/ilan-ramon">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The stamp shows portrait of Ilan Ramon in space suit; the view from the space shuttle of the area of Israel and the Sinai peninsula; map of the stars; Columbia Space Shuttle; Israel Space Agency (ISA) emblem; sunrise as seen from space; and flight symbol STS 107.<br/> The selvedge of the stamp sheet shows satellite photograph of Jerusalem and the Dead Sea; the milky way; Columbia Space Shuttle; the Israeli and USA flags; starfield (photograph by “Hubble” telescope).<br/>Photographs courtesy of NASA.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S59</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ilan Ramon - First Day Cover" href="/stamp/ilan-ramon-first-day-cover">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The stamp shows portrait of Ilan Ramon in space suit; the view from the space shuttle of the area of Israel and the Sinai peninsula; map of the stars; Columbia Space Shuttle; Israel Space Agency (ISA) emblem; sunrise as seen from space; and flight symbol STS 107.<br/> The selvedge of the stamp sheet shows satellite photograph of Jerusalem and the Dead Sea; the milky way; Columbia Space Shuttle; the Israeli and USA flags; starfield (photograph by “Hubble” telescope).<br/>Photographs courtesy of NASA.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$180</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S60</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ilan Ramon - Sheetlet and First Day Cover" href="/stamp/ilan-ramon-first-day-cover2">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S11</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Jerusalem 2001 Multinational Stamp Exhibition Jerusalem 'Bezalel' Ceramics, Ze'ev Raban 1925" href="/stamp/jerusalem-2001-multinational-stamp-exhibition">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S42</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Memorial Day 2003" href="/stamp/memorial-day-2003">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S52</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Memorial Day 2004" href="/stamp/memorial-day-2004">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$7.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S21</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Mushrooms" href="/stamp/mushrooms">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$6.9</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S54</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ottoman Clock Topwers in Israel" href="/stamp/ottoman-clock-topwers-in-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S19</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Philately Day - The First Israeli Astronaut" href="/stamp/philately-day-the-first-israeli-astronaut">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S48</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Philately Day Children & Wheels" href="/stamp/philately-day-children-wheels">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$30</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S2</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Philately Day: Dinosaur, Judean Hills" href="/stamp/dinosaur">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$32</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S8</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Pilmigrage to the Holy Land Part 2: All Apostles Church, Capernaum" href="/stamp/pilmigrage-to-the-holy-land-all-apostles-church-capernaum-sheetlet-of-10">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.9</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S3</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Pilmigrage to the Holy Land Part 2: All Apostles Church, Capernaum; St.Andrew's Church" href="/stamp/pilmigrage-holy-land">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$32</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S4</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Pilmigrage to the Holy Land Part 2: St.Andrew's Church, Jerusalem" href="/stamp/pilmigrage-to-the-holy-land-st-andrews-church-jerysalem-sheetlet-of-10">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$32</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S9</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Pilmigrage to the Holy Land Part 2: The Church of the Visitation, Ein Kerem" href="/stamp/pilmigrage-to-the-holy-land-the-church-of-the-visitation-ein-kerem-sheetlet-of-10">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S49</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Red Sea Fishes Hong-Kong Expo" href="/stamp/red-sea-fishes-hong-kong-expo-s-s">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The Red Sea is part of the tropical regions of the world that are characterized by coral reefs in which there are many unique life forms, with the richest biodiversity in the ocean environment. This series of stamps on reef fishes of the Red Sea presents typical representatives of this spectacular underwater world with its amazing colors and outstanding beauty.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$5.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S50</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Red Sea Fishes Hong-Kong Expo" href="/stamp/red-sea-fishes-hong-kong-expo">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The Red Sea is part of the tropical regions of the world that are characterized by coral reefs in which there are many unique life forms, with the richest biodiversity in the ocean environment. This series of stamps on reef fishes of the Red Sea presents typical representatives of this spectacular underwater world with its amazing colors and outstanding beauty.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S61</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Red Sea Fishes Hong-Kong Expo - First Day Cover" href="/stamp/red-sea-fishes-hong-kong-expo-first-day-cover">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The Red Sea is part of the tropical regions of the world that are characterized by coral reefs in which there are many unique life forms, with the richest biodiversity in the ocean environment. This series of stamps on reef fishes of the Red Sea presents typical representatives of this spectacular underwater world with its amazing colors and outstanding beauty.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$15.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S62</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Red Sea Fishes Hong-Kong Expo - First Day Cover 2" href="/stamp/red-sea-fishes-hong-kong-expo-first-day-cover-2">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>The Red Sea is part of the tropical regions of the world that are characterized by coral reefs in which there are many unique life forms, with the richest biodiversity in the ocean environment. This series of stamps on reef fishes of the Red Sea presents typical representatives of this spectacular underwater world with its amazing colors and outstanding beauty.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$16.8</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S63</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2004">2004</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Red Sea Fishes Hong-Kong Expo - First Day Cover with print error" href="/stamp/red-sea-fishes-hong-kong-expo-first-day-cover-print-error">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$12.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S5</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2000">2000</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Science Fiction: Robotics, Travel in Time, Travel in Space" href="/stamp/science-fiction">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.9</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S36</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Sheik Ameen Tarif" href="/stamp/sheik-ameen-tarif">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$12.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S6</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Hebrew Alphabet" href="/stamp/the-hebrew-alphabet">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>In the second millennium BCE the Babylonians and the Assyrians wrote in the cuneiform script and the Egyptians - in their hieroglyphs, these scripts contained hundred of signs and only scribes and a few learned persons knew how to read and write.</p> <p>The Canaanites, c. 1800 BCE, by inventing a writing system for their language, bestowed the alphabet to human civilization and thus eventually to worldwide literacy. They employed pictographs reminiscent of those of the hieroglyphs, but whereas in the Egyptian writing each picture stood for its name, in the Canaanite script it represented only the first sound of the picture's name. The drawing of a house {bayit) symbolized b, that of the palm of the hand {kaf} signed k, water {mayim)-m, head {rosh)-r, etc.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$10.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S7</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Hebrew Alphabet - Final Letters" href="/stamp/the-hebrew-alphabet-final-letter">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$0.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S27</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 0.2" href="/stamp/the-menorah-0-2">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Different and varied artifacts were found in the Jewish Temple on the Temple Mount in Jerusalem as were found in other ancient places of worship. Three objects were particular only to the Jerusalem Temple: The Table of Showbread, incense altar and the seven-branched menorah made of pure gold. The menorah became the symbol of the people of Israel. The Bible contains descriptions of both the seven-branched menorah and the menorah in the vision of the prophet Zechariah, (Exodus 25 31-40,37 17-24; Zechariah 4 1-7). With the destruction of the First Temple by Nebuchadnezzar, King of Babylon (586 B.C.E) the menorah was taken, along with other treasures, from the Temple to Babylon and its fate was unknown.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$0.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S28</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 0.3" href="/stamp/the-menorah-0-3">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Different and varied artifacts were found in the Jewish Temple on the Temple Mount in Jerusalem as were found in other ancient places of worship. Three objects were particular only to the Jerusalem Temple: The Table of Showbread, incense altar and the seven-branched menorah made of pure gold. The menorah became the symbol of the people of Israel. The Bible contains descriptions of both the seven-branched menorah and the menorah in the vision of the prophet Zechariah, (Exodus 25 31-40,37 17-24; Zechariah 4 1-7). With the destruction of the First Temple by Nebuchadnezzar, King of Babylon (586 B.C.E) the menorah was taken, along with other treasures, from the Temple to Babylon and its fate was unknown.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$0.5</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S29</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 0.4" href="/stamp/the-menorah-0-4">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Different and varied artifacts were found in the Jewish Temple on the Temple Mount in Jerusalem as were found in other ancient places of worship. Three objects were particular only to the Jerusalem Temple: The Table of Showbread, incense altar and the seven-branched menorah made of pure gold. The menorah became the symbol of the people of Israel. The Bible contains descriptions of both the seven-branched menorah and the menorah in the vision of the prophet Zechariah, (Exodus 25 31-40,37 17-24; Zechariah 4 1-7). With the destruction of the First Temple by Nebuchadnezzar, King of Babylon (586 B.C.E) the menorah was taken, along with other treasures, from the Temple to Babylon and its fate was unknown.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$0.6</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S30</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 0.5" href="/stamp/the-menorah-0-5">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Different and varied artifacts were found in the Jewish Temple on the Temple Mount in Jerusalem as were found in other ancient places of worship. Three objects were particular only to the Jerusalem Temple: The Table of Showbread, incense altar and the seven-branched menorah made of pure gold. The menorah became the symbol of the people of Israel. The Bible contains descriptions of both the seven-branched menorah and the menorah in the vision of the prophet Zechariah, (Exodus 25 31-40,37 17-24; Zechariah 4 1-7). With the destruction of the First Temple by Nebuchadnezzar, King of Babylon (586 B.C.E) the menorah was taken, along with other treasures, from the Temple to Babylon and its fate was unknown.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.1</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S31</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 1" href="/stamp/the-menorah-1">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>Different and varied artifacts were found in the Jewish Temple on the Temple Mount in Jerusalem as were found in other ancient places of worship. Three objects were particular only to the Jerusalem Temple: The Table of Showbread, incense altar and the seven-branched menorah made of pure gold. The menorah became the symbol of the people of Israel. The Bible contains descriptions of both the seven-branched menorah and the menorah in the vision of the prophet Zechariah, (Exodus 25 31-40,37 17-24; Zechariah 4 1-7). With the destruction of the First Temple by Nebuchadnezzar, King of Babylon (586 B.C.E) the menorah was taken, along with other treasures, from the Temple to Babylon and its fate was unknown.</p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.4</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S32</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Menorah - 1.3" href="/stamp/the-menorah-1-3">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$16</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S20</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2002">2002</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Months of the Year - Booklet" href="/stamp/the-months-of-the-year-booklet">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$3.2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S13</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Terraces of the Shrine of the Bab, Haifa" href="/stamp/the-terraces-of-the-shrine-of-the-bab-haifa">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$12.2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S33</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="The Wright Brothers' Flight" href="/stamp/the-wright-brothers-flight">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$7.9</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S10</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2001">2001</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Wild Animals in Israel: Lesser Kestrel, Kuhlws Pipistrelle, Roe Deer, Greek Tortoise" href="/stamp/wild-animals-in-israel">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S39</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ya'akov Dori" href="/stamp/yaakov-dori">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S38</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Ya'akov Meridor" href="/stamp/yaakov-meridor">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$4.6</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S45</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Yad Vashem's Jubilee Year" href="/stamp/yad-vashems-jubilee-year">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.3</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S35</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Yeshivot Hesder 1" href="/stamp/yeshivot-hesder-1">Read More</a>
						</div>
			...
			<div class="simpleCart_shelfItem stamp box">
				...
				<div class="right">
					...
					<div class="box">
						...
						<p>'The book and the sword, bound together, descended from Heaven', say the sages. When the State of Israel was established, attempts were made to combine the two - Torah study on one hand and military service on the other. These eventually evolved into the yeshiva (rabbinical college) framework known as 'Hesder'.<br/> The first Hesder yeshiva was established fifty years ago in the month of Cheshvan 5714 (1954) as Yeshivat Kerem B'Yavneh. HaRav A. Y. Kook, of blessed memory, wrote: 'With the means placed at our disposal, it is now possible to rebuild the illustrious Yeshiva, the most significant element of the renowned and beloved Yavneh community ..... reawakening the vital spiritual life of ancient Kerem B'Yavneh.' </p>
						<p class="price item_price"><span class="bold">Price:</span> <span class="stamp-price">$1.2</span></p>
						<p class="cat-num"><span class="bold">Catalog Number:</span>  <span class="stamp-cat-num item_id">S56</span></p>
						<p class="year"><span class="bold">Year:</span> <span class="stamp-year year-2003">2003</span></p>						
					</div>
					
					<div class="box">
						<div class="read-more">
							<a title="Yeshivot Hesder 2" href="/stamp/yeshivot-hesder-2">Read More</a>
						</div>
	...
	<div id="popup" class="hidden">
		...
		<div class="box" style="padding-top: 10px;">
			<p class="align-center">Your cart is updated.</p>
			<p class="align-center">
				<a href="#" title="" class="popup-close" style="padding-right: 15px;">Close</a>
				<a href="/cart" title="" class="popup-cart">View cart</a>
			</p>
		</div>
