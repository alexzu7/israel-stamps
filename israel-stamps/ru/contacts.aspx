<%@ Page inherits="IsraelStamps.ContactsRU" %>
<!DOCTYPE html>
<html>
    <head>
        <title>Contacts | Марки Израиля</title>
		
		
	<meta name="keywords" content="Israel, stamps, philately, contacts" />
	<meta name="description" content="Israel Stamps contacts page" />
		<meta charset="utf-8" />
	...
	<body>
		...
		<div id="bread-crumbs" class="box">
			<div class="center">
                <div class="box"><p>
	<a href="index" title="">Домашняя страница</a> &gt; Контакты</p></div>
            </div>
		</div>
	...
	<div class="center form-box-center">
		<div class="form-box">
			...
			<div class="box">
				<p class="dotted-title">Контакты / <a title="" href="mailto:alexisraelstamps@gmail.com">alexisraelstamps@gmail.com</a></p>
			</div>
			...
			<form id="Form1" runat="server">
				...
				<div class="box row align-right">
					<input type="submit" value=" Отправить " id="send" runat="server" />
				</div>
